...
The sources for chordparser can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/titus-ong/chordparser
.. _tarball: https://github.com/titus-ong/chordparser/tarball/master
